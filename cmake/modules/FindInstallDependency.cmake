...
function(psp_build_dep name cmake_file)
    ...
    if(${name} STREQUAL arrow)
        ...
        set(ARROW_BOOST_REQUIRE_LIBRARY OFF)
        ...
        # set(ARROW_USE_NATIVE_INT128 ON)
        ...
        set_property(DIRECTORY "${CMAKE_BINARY_DIR}/${name}-src/cpp/" APPEND PROPERTY INTERFACE_LINK_LIBRARIES Boost::headers)
